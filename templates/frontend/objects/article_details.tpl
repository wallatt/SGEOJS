 ...
 *}
 ...
 <div style="background-image: url('https://static.vecteezy.com/system/resources/previews/002/071/822/large_2x/template-for-science-and-technology-concept-background-free-vector.jpg');">
...
<div >
<h2 style="text-align: left;"> ARTICLES | Volumen {$issue->getData('volume')}</h2>
</div>
 {* <h2 style="text-align: center;">{$publication->getData('section')} hola</h2> *}
	 <h2 style="text-align: left;">{$currentPublication->getData('date_published')}</h2>
	 {* 3 titulo *}
	 <h2 style="text-align: left;">{$publication->getLocalizedTitle()|escape}</h2>
	 {* 4 autor *}
	 ...
	 {if $publication->getData('datePublished')}
		 ...
		 {if $firstPublication->getID() === $publication->getId()}
					 ...
					 <img style="vertical-align: middle;" src="{$baseUrl}/plugins/themes/saludColectiva/templates/frontend/images/openAccess.png" alt="Open Access">
		 ...
		 {else}
			 <h4 style="text-align: left;">{translate key="submissions.published"}
			 ...
			 {if $currentContext}
				 <nav class="pkp_navigation_primary_row"  aria-label="{translate|escape key="common.navigation.site"}">
					 <div  style="float: left !important;">
						 ...
						 {load_menu name="primary" class="button" style="float: left !important;" id="navigationPrimary" }
