{**
 * saludColectiva/templates/frontend/objects/article_summary_continuous.tpl
 *
...
<div class="obj_article_summary">
	...
	<div class="meta">
		{$article->_data["sectionTitle"]} | {$article->getDatePublished()|date_format:"%d-%m-%Y"} <img style="vertical-align: middle;" src="{$baseUrl}/plugins/themes/saludColectiva/templates/frontend/images/openAccess.png" alt="Open Access">
	</div>
	...
	{foreach from=$pubIdPlugins item=pubIdPlugin}
		...
		{if $pubId}
			...
			<div class="doiPublicacionContinua">
				<a href="{$doiUrl}">DOI: {$doiUrl|substr:16}</a>
			</div>
		{/if}
	{/foreach}
